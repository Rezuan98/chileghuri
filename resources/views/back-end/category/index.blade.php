            ...
            <table id="zero_config" class="table table-bordered text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $item->id }}</td>
                        <td>
                            <img src="{{ asset('/storage/'.$item->icon?? 'NO image') }}" width="60" height="60" alt="Category Icon"> </td>
                        <td>{{ $item->name?? 'NO Name' }}</td>
                        <td>
                            <label class="switch">
                                <input type="checkbox" class="status-switch" data-id="{{ $item->id }}" {{ $item->status ? 'checked' : '' }}>
